...
class PickerWidgetState<T> extends State<_PickerWidget> {
  ...
  List<Widget> _buildHeaderViews(BuildContext context) {
    ...
    final _confirm = _buildButton(
        context, picker.confirmText, picker.confirm, picker.confirmTextStyle, false, theme, () => picker.doConfirm(context));
    if (_confirm != null) {
      items.add(_confirm);
    }
  ...
  static Widget? _buildButton(BuildContext context, String? text, Widget? widget, TextStyle? textStyle, bool isCancel,
    ...
    if (widget == null) {
      String? _txt =
          text ?? (isCancel ? PickerLocalizations.of(context).cancelText : PickerLocalizations.of(context).confirmText);
      ...
      return TextButton(
          ...
          onPressed: onPressed,
          child: Text(_txt,
              overflow: TextOverflow.ellipsis, textScaleFactor: MediaQuery.of(context).textScaleFactor, style: textStyle));
    } else {
